...
\]
\[
    = \frac{1}{T_0} \cdot X(k f_0) = \frac{1}{T_0} \cdot
...
\[
    ...
    \frac{n}{T}\right) = \sum\displaylimits_{k = -\infty}^{+\infty} T
...
\subsection{Dimostrare che la TSF di $x(t) = \sum\displaylimits_{n} x_0(t - nT)$
\`e scrivibile tramite la TCF di $x_0(t)$}
