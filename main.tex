...
\[
    ...
    \dt = \int\displaylimits_{-\infty}^{+\infty} x(t - t_0) e^{-j 2 \pi f t} \dt
	=
\]
\[
	\footnote{Poniamo $t' = t - t_0$.}=
	\int\displaylimits_{-\infty}^{+\infty} x(t') \cdot e^{-j 2 \pi f (t' + t_0)}
	\dt ' =	\int\displaylimits_{-\infty}^{+\infty} x(t') \cdot e^{-j 2 \pi f t'}
	e^{-j 2 \pi f t_0} \dt' =
\]
\[
...
variabile indipendente $t$ del segnale $x(t)$ per il coefficiente $\alpha$ si
...
base \`e detta demodulazione. Il dispositivo in trasmissione che attua
...
segue che
\[
	Y(f) = \frac{1}{2} \cdot X(f - f_0) + \frac{1}{2} \cdot X(f + f_0) =
	\frac{X(f - f_0) + X(f + f_0)}{2}.
\]
\begin{proof}
\[
	Y(f) = \int\displaylimits_{-\infty}^{+\infty} y(t) \cdot e^{-j 2 \pi f t}
    \dt = \int\displaylimits_{-\infty}^{+\infty} x(t) \cdot cos(2 \pi f_0 t)
	\cdot e^{-j 2 \pi f t} \dt =
\]
\[
...
\]
\[
	= \frac{1}{2} \int\displaylimits_{-\infty}^{+\infty} x(t) \cdot
	e^{-j 2 \pi (f - f_0)t} \dt + \frac{1}{2}
	\int\displaylimits_{-\infty}^{+\infty} x(t) \cdot e^{-j 2 \pi (f + f_0) t}
    \dt =
\]
\[
...
segue che
\[
	Y(f) = \frac{1}{2j} \cdot X(f - f_0) - \frac{1}{2j} \cdot X(f + f_0) =
	\frac{X(f - f_0) - X(f + f_0)}{2j}.
\]
\begin{proof}
\[
...
\]
\[
	= \frac{1}{2j} \int\displaylimits_{-\infty}^{+\infty} x(t) \cdot
...
segue che
\[
    Y(f) = \frac{e^{j \varphi}}{2} \cdot X(f - f_0) + \frac{e^{-j \varphi}}{2}
    \cdot X(f + f_0) = \frac{e^{j \varphi} \cdot X(f - f_0) +
    e^{-j \varphi} \cdot X(f + f_0)}{2}.
\]
\begin{proof}
\[
    Y(f) = \int\displaylimits_{-\infty}^{+\infty} y(t) \cdot e^{-j 2 \pi f t}
    \dt = \int\displaylimits_{-\infty}^{+\infty} x(t) \cdot
    cos(2 \pi f_0 t + \varphi) \cdot e^{-j 2 \pi f t} \dt =
\]
\[
    = \int\displaylimits_{-\infty}^{+\infty} x(t) \cdot
    \frac{e^{j(2 \pi f_0 t + \varphi)} + e^{-j(2 \pi f_0 t + \varphi)}}{2} \cdot
    e^{-j 2 \pi f t} \dt =
\]
\[
    = \int\displaylimits_{-\infty}^{+\infty} x(t) \cdot \frac{e^{j \varphi}
    \cdot e^{j 2 \pi f_0 t} + e^{-j \varphi} \cdot e^{-j 2 \pi f_0 t +}}{2}
    \cdot e^{-j 2 \pi f t} \dt =
\]
\[
    = \int\displaylimits_{-\infty}^{+\infty} x(t) \cdot \frac{e^{j \varphi}
    \cdot e^{-j 2 \pi (f - f_0) t} + e^{-j \varphi} \cdot
    e^{-j 2 \pi (f + f_0) t}}{2} =
\]
\[
    = \frac{e^{j \varphi}}{2} \int\displaylimits_{-\infty}^{+\infty} x(t) \cdot
    e^{-j 2 \pi (f - f_0) t} \dt + \frac{e^{-j \varphi}}{2}
    \int\displaylimits_{-\infty}^{+\infty} x(t) \cdot
    e^{-j 2 \pi (f + f_0) t} \dt =
\]
\[
    = \frac{e^{j \varphi}}{2} \cdot X(f - f_0) + \frac{e^{-j \varphi}}{2} \cdot
    X(f + f_0) = \frac{e^{j \varphi} \cdot X(f - f_0) + e^{-j \varphi} \cdot
    X(f + f_0)}{2}.
\]
\end{proof}
...
\[
    Y(f) = \int\displaylimits_{-\infty}^{+\infty} y(t) \cdot e^{-j 2 \pi f t}
    \dt = \int\displaylimits_{-\infty}^{+\infty} x(t) \cdot e^{j 2 \pi f_0 t}
    \cdot e^{-j 2 \pi f t} \dt = 
\]
\[
    = \int\displaylimits_{-\infty}^{+\infty} x(t) \cdot e^{-j 2 \pi (f - f_0) t}
